...
当前版本 **0.13.0**；完整审阅与验证记录见 [发布审计](docs/AUDIT_2026-09-05.md)，安全边界与已知依赖限制见 [安全政策](SECURITY.md)。
...
- Git 感知的本地项目索引，按路径、内容和工作区状态自动选择相关文件。索引在本地建立；使用远程模型时，选入上下文的文件内容会发送给所选 Provider。
